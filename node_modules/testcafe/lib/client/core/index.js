...
(function () {
    ...
    ***************************************************************************** */
    ...
    function hiddenUsingStyles(el) {
        return adapter$1.style.get(el, 'visibility') === 'hidden' ||
            adapter$1.style.get(el, 'display') === 'none';
    }
    ...
    function isElementVisible$1(el) {
        ...
        if (adapter$1.dom.isSVGElement(el)) {
            var hiddenParent = adapter$1.dom.findParent(el, true, function (parent) {
    ...
    initializeAdapter$1({
        position: positionUtils, style: styleUtils$1, event: eventUtils,
    ...
    var HammerheadScriptExecutionEmitter = /** @class */ (function (_super) {
        ...
        HammerheadScriptExecutionEmitter.prototype._onScriptElementAdded = function (script) {
            var _this = this;
            var scriptSrc = nativeMethods$3.scriptSrcGetter.call(script);
            if (scriptSrc === void 0 || scriptSrc === '')
                return;
            this.emit(SCRIPT_ADDED, script);
            var done = function () {
                nativeMethods$3.removeEventListener.call(script, 'load', done);
                nativeMethods$3.removeEventListener.call(script, 'error', done);
                _this.emit(SCRIPT_LOADED_OR_FAILED, script);
            };
            nativeMethods$3.addEventListener.call(script, 'load', done);
            nativeMethods$3.addEventListener.call(script, 'error', done);
        };
