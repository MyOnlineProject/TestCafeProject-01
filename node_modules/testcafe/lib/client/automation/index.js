...
(function () {
    function initTestCafeAutomation(window, isIFrameWithoutSrc) {
        ...
        (function (testCafeCore, testCafeUI, Promise$e, hammerhead) {
    ...
    ***************************************************************************** */
    ...
    function getDevicePoint(clientPoint) {
        return __awaiter(this, void 0, hammerhead.Promise, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, hammerhead.Promise.resolve(adapter.position.getWindowPosition())
    ...
    var position = testCafeCore__default.positionUtils, ScrollAutomation = testCafeCore__default.ScrollAutomation, style = testCafeCore__default.styleUtils, event = testCafeCore__default.eventUtils;
    initializeAdapter({
        scroll: function (el, scrollOptions) { return new ScrollAutomation(el, scrollOptions).run(); },
        getElementExceptUI: getElementFromPoint,
        position: position, style: style, event: event,
    ...
    var DispatchEventAutomation = /** @class */ (function () {
        ...
        DispatchEventAutomation._getEventCtorFromNativeMethods = function (eventCtor) {
            var ctor = nativeMethods$4['Window' + eventCtor] || DispatchEventAutomation._getEventCtorFromWindow(eventCtor);
            return ctor;
        };
    ...
    function getNodeText(el) {
        return nativeMethods$5.nodeTextContentGetter.call(el);
    }
    ...
    function getAutomationPoint(element, offset) {
        return hammerhead.Promise.resolve(isDocumentElement(element))
            ...
            return hammerhead.Promise.resolve(adapter.position.getOffsetPosition(element, roundFn))
    ...
    function findElementOrNonEmptyChildFromPoint(point, element) {
        return hammerhead.Promise.resolve(adapter.position.getElementFromPoint(point))
    ...
    function correctTopElementByExpectedElement(topElement, expectedElement) {
        ...
        return hammerhead.Promise.resolve(closest(expectedElement, 'a'))
            ...
            if (!shouldSearchForMultilineLink)
                return topElement;
            return hammerhead.Promise.resolve(adapter.position.getClientDimensions(expectedElement))
    ...
    function delay(ms) {
        ...
        return new hammerhead.Promise(function (resolve) { return setTimeout(resolve, ms); });
    }
    ...
    var RequestAuthOptions = /** @class */ (function (_super) {
        ...
        RequestAuthOptions.prototype._getAssignableProperties = function () {
            return [
    ...
    var RequestProxyOptions = /** @class */ (function (_super) {
        ...
        RequestProxyOptions.prototype._getAssignableProperties = function () {
            return [
    ...
    var RequestOptions = /** @class */ (function (_super) {
        ...
        RequestOptions.prototype._getAssignableProperties = function () {
            return [
    ...
    var GetProxyUrlOptions = /** @class */ (function (_super) {
        ...
        GetProxyUrlOptions.prototype._getAssignableProperties = function () {
            return [
    ...
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.getTarget = function (element, window, offset) {
            ...
            return hammerhead.Promise.resolve(adapter.position.containsOffset(element, offset.x, offset.y))
                .then(function (containsOffset) {
                if (!containsOffset) {
                    return hammerhead.Promise.all([
                        getAutomationPoint(element, offset),
                        testCafeCore.domUtils.getDocumentElement(window),
                    ])
                        .then(function (_a) {
        ...
        MoveAutomation.prototype._getTargetClientPoint = function () {
            var _this = this;
            return hammerhead.Promise.resolve(adapter.style.getElementScroll(this.element))
                .then(function (scroll) {
                if (testCafeCore.domUtils.isHtmlElement(_this.element)) {
                    return AxisValues.create(_this.offset)
                        .sub(AxisValues.create(scroll))
                        .round(Math.round);
                }
                return hammerhead.Promise.resolve(adapter.position.getClientPosition(_this.element))
                    .then(function (clientPosition) {
                    var isDocumentBody = testCafeCore.domUtils.isBodyElement(_this.element);
                    // @ts-ignore
        ...
        MoveAutomation.prototype._moveToCurrentFrame = function (endPoint) {
            ...
            return hammerhead.Promise.resolve()
                ...
                if (activeWindow.parent === _this.window) {
                    return hammerhead.Promise.resolve(testCafeCore.domUtils.findIframeByWindow(activeWindow))
                        .then(function (frame) {
                        iframe = frame;
                        return hammerhead.Promise.resolve(adapter.position.getIframeClientCoordinates(frame))
                            .then(function (rect) {
                            msg.left = rect.left;
                            msg.top = rect.top;
                ...
                if (iframeUnderCursor || testCafeCore.domUtils.isIframeWindow(_this.window))
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        ClickAutomation.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                return Promise$e.all([delay(_this.automationSettings.mouseActionStepDelay), _this.cursor
                        .leftButtonDown()
    ...
    var SelectChildClickAutomation = /** @class */ (function () {
        ...
        SelectChildClickAutomation.prototype._calculateEventArguments = function () {
            ...
            return {
                options: this.modifiers,
                element: browserUtils$5.isIE && parentSelectSize ? this.parentSelect : childElement,
            };
        };
        ...
        SelectChildClickAutomation.prototype._mouseup = function () {
            var elementForMouseupEvent = browserUtils$5.isIE ? this.parentSelect : this.eventsArgs.element;
            eventSimulator$6.mouseup(elementForMouseupEvent, this.eventsArgs.options);
            if (browserUtils$5.isIE && this.clickCausesChange)
                this.parentSelect.selectedIndex = this.childIndex;
            var simulateInputEventOnValueChange = browserUtils$5.isFirefox || browserUtils$5.isSafari ||
                browserUtils$5.isChrome && browserUtils$5.version >= 53;
            var simulateChangeEventOnValueChange = simulateInputEventOnValueChange || browserUtils$5.isIE;
    ...
    function correctTopElementByExpectedElement$1(topElement, expectedElement) {
        ...
        if (browserUtils$7.isFirefox && isImageMapArea)
    ...
    function getElementFromPoint$2(point /*: AxisValuesData<number>*/, expectedElement) {
        return fromPoint(point)
            ...
            // element is under any of shadow-ui elements, you will get null (only in IE).
            // In this case, you should hide a top window's shadow-ui root to obtain an element.
            var resChain = Promise$6.resolve(topElement);
    ...
    function getAutomationPoint$1(element, offsetX, offsetY) {
        var roundFn = browserUtils$8.isFirefox ? Math.ceil : Math.round;
    ...
    function _updateSelectionAfterDeletionContent(element, selection) {
        ...
        var browserRequiresSelectionUpdating = browserUtils$9.isChrome && browserUtils$9.version < 58 || browserUtils$9.isSafari;
    ...
    function simulateTextInput(element, text) {
        ...
        var isInputEventRequired = browserUtils$9.isFirefox || eventSimulator$9.textInput(element, text) || forceInputInSafari;
        if (browserUtils$9.isSafari) {
        ...
        return isInputEventRequired || browserUtils$9.isIE11;
    }
    function _typeTextToContentEditable(element, text) {
        ...
        var beforeContentChanged = function () {
            ...
            needRaiseInputEvent = needProcessInput && !browserUtils$9.isIE11;
        ...
        if (!startNode || !domUtils$8.isContentEditableElement(startNode) || !domUtils$8.isRenderedNode(startNode))
            return;
        if (!simulateBeforeInput(element, text, browserUtils$9.isChrome || browserUtils$9.isFirefox))
            return;
        beforeContentChanged();
        if (needProcessInput)
            needProcessInput = simulateBeforeInput(element, text, browserUtils$9.isSafari);
        if (needProcessInput) {
    ...
    function _typeTextToTextEditable(element, text) {
        ...
        var elementMaxLength = !browserUtils$9.isIE && isInputTypeNumber ? null : parseInt(element.maxLength, 10);
        if (elementMaxLength < 0)
            elementMaxLength = browserUtils$9.isIE && browserUtils$9.version < 17 ? 0 : null;
        ...
        if (elementMaxLength === null || isNaN(elementMaxLength) || elementMaxLength >= newElementValue.length) {
            // NOTE: B254013
            if (isInputTypeNumber && browserUtils$9.isIOS && elementValue[elementValue.length - 1] === '.') {
                startSelection += 1;
                endSelection += 1;
            }
    ...
    function getFocusableElementsFilter(sourceElement, skipRadioGroups) {
        ...
        if (skipRadioGroups) {
            ...
            if (sourceElement.name !== '' && !browserUtils$a.isFirefox)
        ...
        else if (browserUtils$a.isChrome)
    ...
    function filterFocusableElements(elements, sourceElement, skipRadioGroups) {
        if (!isRadioButtonElement$1(sourceElement))
            return elements;
        if (!skipRadioGroups && !sourceElement.name && !browserUtils$a.isChrome)
    ...
    var KeyPressSimulator = /** @class */ (function () {
        ...
        KeyPressSimulator.prototype._type = function (element, char) {
            ...
            try {
                if (elementChanged) {
                    ...
                    shouldType = (!browserUtils$b.isFirefox || isStoredElementEditable) &&
                        (!browserUtils$b.isWebKit || shouldTypeInWebKit);
                }
            }
            ...
            /*eslint-disable no-empty */
            if (shouldType) {
                if (!browserUtils$b.isIE && elementChanged && isStoredElementEditable && isActiveElementEditable)
        ...
        KeyPressSimulator.prototype.press = function (modifiersState) {
            ...
            if (browserUtils$b.isWebKit && elementChanged) {
            ...
            this._addKeyPropertyToEventOptions(eventOptions);
            var raiseDefault = browserUtils$b.isAndroid || eventSimulator$a.keypress(activeElement, extend$2(eventOptions, modifiersState));
            if (!raiseDefault)
                return raiseDefault;
            ...
            var isSafariWithAutoRaisedClick = browserUtils$b.isSafari &&
                browserUtils$b.compareVersions([browserUtils$b.webkitVersion, '603.1.30']) >= 0;
            var isKeyActivatedInputInFirefox = browserUtils$b.isFirefox && isKeyActivatedInput;
            var raiseClickOnEnter = (!browserUtils$b.isFirefox || isKeyActivatedInputInFirefox) && !isSafariWithAutoRaisedClick
        ...
        KeyPressSimulator.prototype.up = function (modifiersState) {
            ...
            var emulateClick = !browserUtils$b.isFirefox && !browserUtils$b.isSafari &&
                (!browserUtils$b.isChrome || browserUtils$b.version >= 53);
    ...
    function up(element) {
        ...
        if (isRadioButtonNavigationRequired(element))
            return focusAndCheckNextRadioButton(element, true);
        if (browserUtils$c.isWebKit && domUtils$9.isInputElement(element))
            return home(element);
        if (domUtils$9.isTextAreaElement(element))
    ...
    function isRadioButtonNavigationRequired(element) {
        return domUtils$9.isRadioButtonElement(element) && !browserUtils$c.isFirefox;
    }
    ...
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype._press = function (keyPressSimulator, keyEventPrevented) {
            ...
            // NOTE: B254435
            if (!currentShortcutHandler || browserUtils$d.isFirefox || keyPressSimulator.key === 'enter')
    ...
    var RClickAutomation = /** @class */ (function (_super) {
        ...
        RClickAutomation.prototype._focus = function (eventArgs) {
            ...
            // NOTE: IE doesn't perform focus if active element has been changed while executing mousedown
            var simulateFocus = !browserUtils$e.isIE || this.eventState.activeElementBeforeMouseDown === domUtils$a.getActiveElement();
            return focusAndSetSelection(elementForFocus, simulateFocus, this.caretPos)
    ...
    function scrollEditableElementByPoint(element, point) {
        ...
        if (isInputElement && (browserUtils$f.isFirefox || browserUtils$f.isIE && browserUtils$f.version > 10))
            return;
        var elementOffset = positionUtils$5.getOffsetPosition(element);
        var elementBorders = styleUtils$5.getBordersWidth(element);
    ...
    function excludeElementScroll(element, point) {
        ...
        if (isInputElement && isTextEditable &&
            (browserUtils$f.isFirefox || browserUtils$f.isIE && browserUtils$f.version > 10)) {
            return {
    ...
    var SelectBaseAutomation = /** @class */ (function (_super) {
        ...
        SelectBaseAutomation.prototype._mousedown = function () {
            ...
            return cursor
                ...
                // NOTE: In WebKit and IE, the mousedown event opens the select element's dropdown;
                // therefore, we should prevent mousedown and hide the dropdown (B236416).
                var needCloseSelectDropDown = (browserUtils$g.isWebKit || browserUtils$g.isIE) &&
    ...
    var browserUtils$h = hammerhead__default.utils.browser;
    ...
    var TypeAutomation = /** @class */ (function () {
        ...
        TypeAutomation.prototype._keypress = function () {
            ...
            this.eventState.simulateTypeChar = browserUtils$h.isAndroid || eventSimulator$e.keypress(this.eventArgs.element, this.eventArgs.options);
        };
...
}(window['%testCafeCore%'], window['%testCafeUI%'], window['%hammerhead%'].Promise, window['%hammerhead%']));
