...
(function () {
    function initTestCafeClientDrivers(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, testCafeAutomation, testCafeCore, Promise$4, testcafeUi) {
    ...
    Promise$4 = Promise$4 && Object.prototype.hasOwnProperty.call(Promise$4, 'default') ? Promise$4['default'] : Promise$4;
    ...
    ***************************************************************************** */
    ...
    function __awaiter(thisArg, _arguments, P, generator) {
        ...
        return new (P || (P = Promise$4))(function (resolve, reject) {
    ...
    var position = testCafeCore__default.positionUtils, style = testCafeCore__default.styleUtils, event = testCafeCore__default.eventUtils;
    ...
    function visible(el) {
        if (testCafeCore.domUtils.isIframeElement(el))
            return testCafeCore.positionUtils.isIframeVisible(el);
    ...
    function delay$1 (ms) {
        return new Promise$1(function (resolve) { return nativeMethods$2.setTimeout.call(window, resolve, ms); });
    }
        ...
        SelectorExecutor.prototype._validateElement = function (args, startTime) {
            ...
            return hammerhead.Promise.resolve()
                ...
                if (isElementExists && (isElementVisible || hammerhead.utils.dom.isShadowRoot(element)))
                    return element;
                if (!isTimeout)
                    return delay$1(CHECK_ELEMENT_DELAY).then(function () { return _this._validateElement(args, startTime); });
    ...
    function executeChildWindowDriverLinkSelector(selector, childWindowLinks) {
        if (typeof selector === 'string') {
            ...
            return Promise$2.resolve(foundChildWindowDriverLink);
        }
        // TODO:  Query url and title properties of the all driverLinks' windows
        return Promise$2.resolve(null);
    }
    ...
    var Driver = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise$3.all(searchQueries)];
                        case 1:
        ...
        Driver.prototype._getCloseWindowFoundResult = function () {
            ...
            return Promise$3.resolve({ success: true });
        };
        ...
        Driver.prototype._closeWindow = function (msg) {
            ...
            return Promise$3.all(searchQueries);
        };
        ...
        Driver.prototype._switchToWindow = function (msg) {
            ...
            if (!this.childWindowDriverLinks.length)
                return Promise$3.resolve();
            return Promise$3.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
        ...
        Driver.prototype._handleChildWindowIsOpenedInIFrame = function () {
            ...
            this._pendingChildWindowInIFrame = new Promise$3(function (resolve) {
        ...
        Driver.prototype._runInActiveIframe = function (command) {
            var _this = this;
            var runningChain = Promise$3.resolve();
        ...
        Driver.prototype._switchToIframe = function (selector, iframeErrorCtors) {
            ...
            return getResult(selector, commandSelectorTimeout, null, function (fn) { return new iframeErrorCtors.NotFoundError(null, fn); }, function () { return new iframeErrorCtors.IsInvisibleError(); }, this.statusBar)
                ...
                return _this._ensureChildIframeDriverLink(nativeMethods$3.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, childLinkResponseTimeout);
            })
        ...
        Driver.prototype._createWaitForEventPromise = function (eventName, timeout) {
            ...
            var timeoutPromise = new Promise$3(function (resolve) {
                nativeMethods$3.setTimeout.call(window, function () {
                    _this.off(eventName, eventHandler);
                    resolve();
                }, timeout);
            });
            var resultPromise = new Promise$3(function (resolve) {
            ...
            return Promise$3.race([timeoutPromise, resultPromise]);
        };
        ...
        Driver.prototype._onExecuteSelectorCommand = function (command) {
            ...
            getResultDriverStatus(command, this.selectorTimeout, startTime, command.needError ? elementNotFound : null, command.needError ? elementIsInvisible : null, this.statusBar)
                .then(function (driverStatus) {
                    ...
                    switch (_a.label) {
                        case 0:
                            if (!this.contextStorage.getItem(PENDING_CHILD_WINDOW_COUNT))
                                return [2 /*return*/];
                            restoreChildWindowsPromise = new Promise$3(function (resolve) {
